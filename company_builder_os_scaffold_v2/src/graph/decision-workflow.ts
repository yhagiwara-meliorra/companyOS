...
export function createDecisionWorkflow(deps: DecisionWorkflowDeps) {
  ...
  const afterApprovalRouter: ConditionalEdgeRouter<
  ...
  return new StateGraph({
    ...
    .addConditionalEdges("approvalGate", afterApprovalRouter, ["persistDecisionPacket", END])
